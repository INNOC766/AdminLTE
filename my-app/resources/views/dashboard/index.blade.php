...
@section('content')
    ...
    {{-- End Small Box Widgets --}}

    {{-- Charts & Direct Chat Row --}}
    <div class="row">
        ...
        <div class="col-lg-5 connectedSortable">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6"><div id="sparkline-1"></div><p class="text-center text-secondary fs-7 mt-1">Revenue</p></div>
                        <div class="col-md-6"><div id="sparkline-2"></div><p class="text-center text-secondary fs-7 mt-1">Sales</p></div>
                    </div>
                </div>
            </div>
        </div>
...
@push('scripts')
    ...
    <script>
        ...
        const sparklineOpts = (data, color) => ({
            series: [{ data }],
        ...
        new ApexCharts(document.querySelector('#sparkline-1'), sparklineOpts([1000,1200,920,927,931,1027,819,930,1021], '#DCE6EC')).render();
        new ApexCharts(document.querySelector('#sparkline-2'), sparklineOpts([515,519,520,522,652,810,370,627,319,630,921], '#DCE6EC')).render();
    </script>
